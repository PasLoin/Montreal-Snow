...
def main():
    ...
    print("Plotting the complete graph of odd degree nodes")
    fig, ax = plt.subplots()
    pl.plot_complete_graph_odd_degree(g_odd_complete, node_positions, ax=ax)
    plt.show()
    ...
    print("Plotting minimum weight matching complete graph")
    fig, ax = plt.subplots()
    pl.plot_min_weight_matching_complete(g_odd_complete, g_odd_complete_min_edges, node_positions, ax=ax)
    plt.show()

    print("Plotting minimum weight matching original graph")
    fig, ax = plt.subplots()
    pl.plot_min_weight_matching_original(G, g_odd_complete_min_edges, node_positions, ax=ax)
    plt.show()
    ...
    # Plot the route
    fig, ax = plt.subplots()
    pl.plot_path(lat, long, origin_point, dest_point, ax=ax)
    plt.show()
